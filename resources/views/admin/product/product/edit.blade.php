...
@section('header_styles')
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::model($product, ['method' => 'PATCH', 'files'=> true ,'action' => ['Admin\Product\ProductController@update', $product->id] ])     !!}

                        @include('admin.product.product._form')
    ...
    {{--my javascript--}}
    <script type="text/javascript" src="{{ asset('productListControl.jstControl.js') }}"></script>
@stop