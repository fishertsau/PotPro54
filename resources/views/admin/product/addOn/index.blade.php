            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ route('admin.product.addOn.create') }}" class="btn btn-sm btn-default"><span
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    @foreach($add_on->options as $option)
                                        <a href="/admin/product/addOnOption/{{$option->pivot->add_on_option_id}}/edit" title="{{$option->settings_string}}">
