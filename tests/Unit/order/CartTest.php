...
class CartTest extends TestCase
{
    ...
    {
//        $productA = factory(Group::class)->create()->products()->create(['title' => 'A']);
//        $productB = factory(Group::class)->create()->products()->create(['title' => 'B']);
...
//        $this->assertEquals(16200, Cart::total());
    ...
    {
//        $product = factory(Group::class)->create()->products()->create(['title' => 'A']);
