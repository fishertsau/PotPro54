...
class ChannelController extends Controller
{
    ...
    {
        Channel::create(['user_id' => request('user_id')]);

        return redirect(
            route('admin.channels.edit', request('user_id')));
    }

    public function index()
    {
        return view('admin.channel.sales.index');
    }

    public function update($userId)
    {
        Channel::findByUserId($userId)->update(request()->all());
